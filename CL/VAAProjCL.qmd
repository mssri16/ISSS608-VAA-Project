...
=======
=======
>>>>>>> 6f27d5411549b078d7f2a96a26c84c134e79e3a3
>>>>>>> Chee
#| eval: false
glimpse(movie2)
>>>>>>> Chee
...
sample_test_movie_data <- subset(sample_test_movie_data, select = c("id","title","genres","original_language","popularity","production_companies","release_date","budget","revenue","runtime","status","vote_average","vote_count","credits","performance","release_year"))
```
